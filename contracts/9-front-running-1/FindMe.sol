...
contract FindMe {
  ...
  function funnyFunction() public pure returns (string memory) {
    return
      "I am a funny function, I am not used for anyting, I am just here to make you laugh";
  }
  ...
  function complicateFunction() public pure returns (string memory) {
    ...
    return
      "I am a complicate funtion, I am not used for anything, I am just here to make you cry";
  }
