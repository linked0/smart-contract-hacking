...
describe("Optimizer Vaults 101: Exercise 1", () => {
  ...
  before(async () => {
    ...
    const YieldContractFactory = await ethers.getContractFactory(
      "contracts/6-optimizer-vault-1/YieldContract.sol:YieldContract",
      deployer
    );
    const StrategyFactory = await ethers.getContractFactory(
      "contracts/6-optimizer-vault-1/OptimizerStrategy.sol:OptimizerStrategy",
      deployer
    );
    const VaultFactory = await ethers.getContractFactory(
      "contracts/6-optimizer-vault-1/OptimizerVault.sol:OptimizerVault",
      deployer
    );
