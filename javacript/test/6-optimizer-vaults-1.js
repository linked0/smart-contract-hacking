...
describe("Optimizer Vaults 101: Exercise 1", () => {
  ...
  before(async () => {
    ...
    const YieldContractFactory = await ethers.getContractFactory(
        "contracts/6-optimizer-vaults/YieldContract.sol:YieldContract",
        deployer
    );
    const StrategyFactory = await ethers.getContractFactory(
        "contracts/6-optimizer-vaults/OptimizerStrategy.sol:OptimizerStrategy",
        deployer
    );
    const VaultFactory = await ethers.getContractFactory(
        "contracts/6-optimizer-vaults/OptimizerVault.sol:OptimizerVault",
        deployer
    );
